                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="male" name="gender" value="male">
                                <label class="form-check-label" for="male">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="female" name="gender" value="female">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="consultationstatus" class="form-label">Consultation Status</label>
                            <select id="consultationstatus" name="consultationstatus" class="form-select">
                                <option disabled selected>Choose...</option>
                                <option>...</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="extractednumber" name="extractednumber" placeholder="Number">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="active" value="active" name="status">
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inactive" value="inactive" name="status">
