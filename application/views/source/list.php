                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><span class="btn btn-<?php echo $statusarray['class'.$source['status']];  ?> btn-xs"><?php echo $statusarray[$source['status']]; ?></span></td>
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary get-details" data-bs-toggle="modal" url="<?php echo base_url('source/edit/' . $source['id']) ?>" data-bs-target="#editModal" data-bs-whatever="@mdo">Edit</button>
                                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                                            <span class="visually-hidden">Toggle Dropdown</span>
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                            <li><a class="dropdown-item get-details" href="javascript:void(0)" data-bs-toggle="modal" url="<?php echo base_url('source/edit/' . $source['id'] . '/' . $return) ?>" data-bs-target="#editModal" data-bs-whatever="@mdo">Edit</a></li>
                                            <li><a class="dropdown-item deleteModal" href="javascript:void(0)" data-bs-toggle="modal" url="<?php echo base_url('source/delete/' . $source['id'] . '/' . $return) ?>" data-bs-target="#deleteModal" data-bs-whatever="@mdo">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('source/add', array('id' => 'form')); ?>
