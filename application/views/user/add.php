<div class="container-fluid d-md-flex mb-4">
    <?php echo form_open_multipart('user/add/', array('id' => 'form')); ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control req-field required" id="fname" name="fname" placeholder="First Name">
                        </div>
                        <div class="col-md-6">
                            <label for="lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control req-field required" id="lname" name="lname" placeholder="Last Name">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control req-field required" id="contactno" name="contactno" placeholder="Contact Number">
                        </div>
                        <div class="col-md-6">
                            <label for="whatsappno" class="form-label">WhatsApp Number</label>
                            <input type="text" class="form-control req-field required" id="whatsappno" name="whatsappno" placeholder="WhatsApp Number">
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">Email Id</label>
                            <input type="text" class="form-control req-field required" id="email" name="email" placeholder="Email Id">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control req-field required" id="username" name="username" placeholder="Username" autocomplete="off">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control req-field required" id="confirm_password" name="confirm_password" placeholder="Password" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
