...
<section>
    ...
    <div class="form-control mx-auto">
        <div class="table-heading d-flex align-items-center justify-content-between p-2">
            <p class="fs-2">Consultation Status</p>
        ...
        <div class="table-responsive">
            <table class="table align-middle table-bordered table-hover table-responsive-sm">
                ...
                <tbody>
                    <?php
                    if ($consultation_statuses) {
                        foreach ($consultation_statuses as $consultation_status) {
                    ?>
                            <tr>
                                <td><?php echo $consultation_status['name']; ?></td>
                                <td><span class="btn btn-<?php echo $statusarray['class'.$consultation_status['status']];  ?> btn-xs"><?php echo $statusarray[$consultation_status['status']]; ?></span></td>
                                <td>
                                    <div class="btn-group">
...
<section class="section-pop-up mx-auto">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Consultation Status</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <?php echo form_open('consultation_status/add', array('id' => 'form')); ?>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Consultation Status</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div id="get-details">
