...
<section>
    ...
    <div class="form-control mx-auto">
        <div class="table-heading d-flex align-items-center justify-content-between p-2">
            ...
            <button class="btn button-color btn-primary button-primary float-end ajaxPopup" url="<?php echo base_url('appointment/add/'.$patient_id);?>" data-bs-toggle="modal" data-bs-target="#addModal" data-bs-whatever="@mdo">Add</button>
        </div>
